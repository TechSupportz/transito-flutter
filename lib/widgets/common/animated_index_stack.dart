...
class _AnimatedIndexedStackState extends State<AnimatedIndexedStack> with TickerProviderStateMixin {
  ...
  void _updateEntriesList() {
    ...
    for (final child in widget.children) {
      ...
      int existingIndex = _entries.indexWhere((entry) => Widget.canUpdate(entry.child, child));
    ...
    bool previousWasRemoved = previousEntry != null && !entries.contains(previousEntry);
