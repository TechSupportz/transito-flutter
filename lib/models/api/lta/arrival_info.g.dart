...
BusArrivalInfo _$BusArrivalInfoFromJson(Map<String, dynamic> json) => BusArrivalInfo(
...
ServiceInfo _$ServiceInfoFromJson(Map<String, dynamic> json) => ServiceInfo(
  ...
  nextBus: IndivArrivalInfo.fromJson(json['NextBus'] as Map<String, dynamic>),
  nextBus2: IndivArrivalInfo.fromJson(json['NextBus2'] as Map<String, dynamic>),
  nextBus3: IndivArrivalInfo.fromJson(json['NextBus3'] as Map<String, dynamic>),
);

IndivArrivalInfo _$IndivArrivalInfoFromJson(Map<String, dynamic> json) => IndivArrivalInfo(
  ...
  $enumDecodeNullable(_$CrowdLvlEnumMap, json['Load'], unknownValue: CrowdLvl.NA) ?? CrowdLvl.NA,
  IndivArrivalInfo.decodeIsAccessible(json['Feature'] as String),
  $enumDecodeNullable(_$BusTypeEnumMap, json['Type'], unknownValue: BusType.NA) ?? BusType.NA,
);
...
const _$BusTypeEnumMap = {BusType.SD: 'SD', BusType.DD: 'DD', BusType.BD: 'BD', BusType.NA: 'NA'};
