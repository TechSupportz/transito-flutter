...
BusStopProviderSources _$BusStopProviderSourcesFromJson(
  Map<String, dynamic> json,
) => BusStopProviderSources(
  lta: json['LTA'] as String?,
  nus: json['NUS'] as String?,
);

Map<String, dynamic> _$BusStopProviderSourcesToJson(
  BusStopProviderSources instance,
...
BusStop _$BusStopFromJson(Map<String, dynamic> json) => BusStop(
  ...
  sources: json['sources'] == null
      ? null
      : BusStopProviderSources.fromJson(
...
BusStopDetailsApiResponse _$BusStopDetailsApiResponseFromJson(
  Map<String, dynamic> json,
