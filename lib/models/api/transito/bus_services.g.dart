...
AllBusServices _$AllBusServicesFromJson(Map<String, dynamic> json) => AllBusServices(
...
BusStopServicesApiResponse _$BusStopServicesApiResponseFromJson(Map<String, dynamic> json) =>
    BusStopServicesApiResponse(
      count: (json['count'] as num).toInt(),
      data: (json['data'] as List<dynamic>).map((e) => e as String).toList(),
    );

BusServiceSearchApiResponse _$BusServiceSearchApiResponseFromJson(Map<String, dynamic> json) =>
...
BusServiceDetailsApiResponse _$BusServiceDetailsApiResponseFromJson(Map<String, dynamic> json) =>
...
BusService _$BusServiceFromJson(Map<String, dynamic> json) => BusService(
  ...
  operator:
      $enumDecodeNullable(_$BusOperatorEnumMap, json['operator'], unknownValue: BusOperator.NA) ??
      BusOperator.NA,
...
Map<String, dynamic> _$BusServiceToJson(BusService instance) => <String, dynamic>{
  ...
  'routes': instance.routes?.map((e) => e.map((e) => e.toJson()).toList()).toList(),
};
