...
BusStopServicesApiResponse _$BusStopServicesApiResponseFromJson(
  ...
  data: (json['data'] as List<dynamic>)
      .map((e) => BusStopServiceDetailed.fromJson(e as Map<String, dynamic>))
      .toList(),
);

BusStopServiceDetailed _$BusStopServiceDetailedFromJson(
  Map<String, dynamic> json,
) => BusStopServiceDetailed(
  serviceNo: json['serviceNo'] as String,
  originStopCode: json['originStopCode'] as String,
  destinationStopCode: json['destinationStopCode'] as String,
