...
FavouritesList _$FavouritesListFromJson(Map<String, dynamic> json) => FavouritesList(
  favouritesList: (json['favouritesList'] as List<dynamic>)
      .map((e) => Favourite.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$FavouritesListToJson(FavouritesList instance) => <String, dynamic>{
