...
class QuickStartTourController extends ChangeNotifier {
  ...
  static const List<QuickStartTourStep> steps = [
    ...
    QuickStartTourStep(
      ...
      title: 'Pick a stop',
      message: 'Tap a stop to view bus arrival timings.',
    ...
    QuickStartTourStep(
      ...
      title: 'Stop details',
      message: 'You can return to the bus timing screen when you are ready.',
      allowsInteraction: true,
      showPrimaryAction: false,
      spotlightRadius: 12,
    ),
    QuickStartTourStep(
      ...
      message: 'Tap a service number to view more information.',
      allowsInteraction: true,
      showPrimaryAction: false,
    ...
    QuickStartTourStep(
      ...
      title: 'Search',
      message: 'Use this field to find places, bus stops, or services.',
      spotlightRadius: 12,
    ),
    QuickStartTourStep(
    ...
    QuickStartTourStep(
      ...
      title: 'MRT map',
      message: 'Tap MRT Map for quick reference. It even works offline!',
      allowsInteraction: true,
      showPrimaryAction: false,
      spotlightRadius: 12,
    ),
    ...
    QuickStartTourStep(
      ...
      title: 'Make it yours',
      message: 'Open Settings to customise your experience.',
      allowsInteraction: true,
      showPrimaryAction: false,
      spotlightRadius: 12,
    ),
    QuickStartTourStep(
      ...
      message:
          'You\'re all set. Explore the settings to customise your experience, or return to Nearby to start using the app. Enjoy your journey!',
      highlightBehavior: QuickStartHighlightBehavior.pagePulse,
